...
<section class="d-flex justify-content-center">
    ...
    <div class="mb-2">
        ...
        <input type="file" class="form-control" name="senalesemg" accept=".txt,.bin" value="{{ $diagnostico->senalesemg }}">
    </div>
    ...
    <div class="mb-2">
        <input type="submit" class="col-12 btn btn-primary d-flex justify-content-center" value="Editar Diagnóstico">
    </div>
