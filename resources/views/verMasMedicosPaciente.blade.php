...
<head>
    ...
    <link href="{{ asset('css/verMasMedicoStyle.css') }}" rel="stylesheet">
...
<!--Esta pantalla es parte del flujo del paciente, cuando presiona el botón de "Ver más" 
    En la lista de los médicos para solicitar una asistencia-->
